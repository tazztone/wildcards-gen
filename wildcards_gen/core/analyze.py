...
def compute_dataset_stats(
    data: Union[Dict, List, CommentedMap, CommentedSeq],
) -> DatasetStats:
    """
...
def print_analysis_report(stats: DatasetStats, suggestions: Dict[str, int]):
    ...
    print(
        f"  --smart --min-depth {suggestions['min_depth']} --min-hyponyms {suggestions['min_hyponyms']} --min-leaf {suggestions['min_leaf_size']}"
    )
