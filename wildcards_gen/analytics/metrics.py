...
def calculate_stability(
    terms1: Set[str], labels1: Dict[str, str], terms2: Set[str], labels2: Dict[str, str]
) -> Dict[str, float]:
    """
    ...
    if not check_dependencies():
        raise ImportError("Missing 'scikit-learn'. Install with: pip install wildcards-gen[lint]")
