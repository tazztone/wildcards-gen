...
class TestArranger(unittest.TestCase):
    ...
    def test_arrange_list_basic(
        ...
        with patch("hdbscan.HDBSCAN") as MockHDBSCAN:
            ...
            # Run
            groups, leftovers, _, _ = arrange_list(self.items, model_name="dummy", threshold=0.5, min_cluster_size=2)
    ...
    @patch("wildcards_gen.core.arranger.compute_umap_embeddings")
    @patch("wildcards_gen.core.arranger.get_lca_name")
    def test_arrange_list_threshold_filtering(
        self,
        mock_get_name,
        mock_umap,
        mock_get_embeddings,
    ...
    def test_return_metadata(
        ...
        with patch("hdbscan.HDBSCAN") as MockHDBSCAN:
            ...
            self.assertEqual(len(res), 4)  # groups, leftovers, stats, meta

            # Call with metadata
            groups, leftovers, _, metadata = arrange_list(
                self.items[:3],
                model_name="dummy",
