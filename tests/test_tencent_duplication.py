...
class TestTencentDuplication(unittest.TestCase):
    def test_duplication_on_flatten(self):
        ...
        with (
            patch("wildcards_gen.core.datasets.tencent.parse_hierarchy_file") as mock_parse,
            ...
            config_obj = SmartConfig(enabled=True, min_leaf_size=5, merge_orphans=True, semantic_arrangement=False)
