...
def test_openimages_smoke_execution_smart_flatten():
    ...
    mock_id_to_name = {"/m/root": "Entity", "/m/obj1": "Object1", "/m/obj2": "Object2"}
    ...
    with (
        patch(
            ...
            return_value=(mock_hierarchy, mock_id_to_name),
        ),
        ...
        config_obj = SmartConfig(
            enabled=True, semantic_arrangement=True, semantic_arrangement_min_cluster=1, min_leaf_size=0
        )
...
def test_tencent_smoke_execution_smart_flatten():
    ...
    with (
        ...
        patch(
            "wildcards_gen.core.datasets.tencent.parse_hierarchy_file",
